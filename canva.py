...
photo1 = PhotoImage(file=r"resources/images/card.png")
width1 = photo1.width()
height1 = photo1.height()
canva = Canvas(width=width1*3 + 70, height=height1 + 50)
canva.pack(expand=1, fill=BOTH) # <--- Make your canvas expandable.
x = (width1)/2.0
y = (height1)/2.0
